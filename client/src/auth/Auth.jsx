...
const Auth = () => {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      ...
      navigate(
        res.data.user.email === "patra6319@gmail.com" ? "/admin" : "/user",
      );
    } catch (err) {
  ...
  const handleRegister = async (e) => {
    if (signUpForm.username.length !== 4) {
      alert("Username must be exactly 4 characters");
      return;
    }
    e.preventDefault();
    try {
      ...
      <div className="min-h-screen w-full flex items-center justify-center relative p-4">
        ...
        <div className="relative bg-amber-50 shadow-2xl overflow-hidden flex flex-col md:flex-row w-full max-w-5xl">
          ...
          <div className="md:w-1/2 bg-gradient-to-br from-green-700 to-green-200 text-white p-8 flex flex-col justify-center">
            ...
            {errorMsg && (
              <div className="bg-red-700/80 text-white p-2 rounded mb-4 text-sm">
                {errorMsg}
              </div>
            )}
            ...
            >
              ...
              <input
                ...
                onChange={(e) => {
                  if (isLogin)
                    setSignInForm((s) => ({ ...s, username: e.target.value }));
                  else
              ...
              <div className="relative">
                ...
                <button
                  ...
                  onClick={() =>
                    isLogin
                      ? setShowSignInPassword((s) => !s)
                      : setShowSignUpPassword((s) => !s)
                  }
